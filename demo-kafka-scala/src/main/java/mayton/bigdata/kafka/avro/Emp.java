...
public class Emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Emp(java.lang.Integer EMPNO, java.lang.CharSequence ENAME, JOBEnum JOB, java.lang.Integer MGR, java.lang.CharSequence HIREDATE, java.lang.Double SAL, java.lang.Double COMM, java.lang.Integer DEPTNO) {
    this.EMPNO = EMPNO;
    this.ENAME = ENAME;
    this.JOB = JOB;
    this.MGR = MGR;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: JOB = (JOBEnum)value$; break;
   ...
   * @param value the value to set.
   */
  public void setJOB(JOBEnum value) {
    this.JOB = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Emp>
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setEMPNO(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setENAME(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setJOB(JOBEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setMGR(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setHIREDATE(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder clearHIREDATE() {
      HIREDATE = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setSAL(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setCOMM(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder setDEPTNO(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Emp.Builder clearDEPTNO() {
    ...
    public Emp build() {
      try {
        ...
        record.JOB = fieldSetFlags()[2] ? this.JOB : (JOBEnum) defaultValue(fields()[2]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.JOB = JOBEnum.values()[in.readEnum()];
  ...
  public int hashCode() {
    int result = 1;
    result = 31 * result + Integer.hashCode(EMPNO);
    result = 31 * result + (ENAME == null ? 0 : ENAME.hashCode());
    result = 31 * result + (JOB == null ? 0 : ((java.lang.Enum) JOB).ordinal());
    result = 31 * result + (MGR == null ? 0 : MGR.hashCode());
    result = 31 * result + (HIREDATE == null ? 0 : HIREDATE.hashCode());
    result = 31 * result + (SAL == null ? 0 : SAL.hashCode());
    result = 31 * result + (COMM == null ? 0 : COMM.hashCode());
    result = 31 * result + Integer.hashCode(DEPTNO);
    return result;
  }
  ...
  public boolean equals(Object o) {
    ...
    if (Utf8.compareSequences(this.ENAME, other.ENAME) != 0) {
      return false;
    }
    if (!java.util.Objects.equals(this.JOB, other.JOB)) {
      return false;
    }
    if (!java.util.Objects.equals(this.MGR, other.MGR)) {
      return false;
    }
    if (Utf8.compareSequences(this.HIREDATE, other.HIREDATE) != 0) {
      return false;
    }
    if (!java.util.Objects.equals(this.SAL, other.SAL)) {
      return false;
    }
    if (!java.util.Objects.equals(this.COMM, other.COMM)) {
      return false;
    }
