...
import mayton.ip2loc.Ipv4LocationServiceRadix;
...
class TestIp2loc {
    ...
    @BeforeAll
    static void init() {
        System.setProperty("mayton.ip2loc.Ipv4LocationServiceRadix.path","~/ip2location-lite-db3.csv");
        ipv4locationService = (Ipv4LocationServiceRadix.getInstance());
    }
